...
We need to practice our data wrangling and tidying skills, in addition to importing different types of data. Thus, we'll bring in `tidyverse` and `readxl`. For Problem 3, we need the `p8105.datasets` package.
...
`tidy_precipitation` tells us that 7.47 inches of rain fell in 2017, given the data that was present for that year.
...
We went from 134203 rows and 23 columns in the raw BRFSS dataset to 2125 rows and 9 columns in the cleaned dataset. Each `response_value` now has its own column with the `data_value` column populating each cell. On an interesting side note, `spread()` does not work as intended if you try to spread before you remove the large amount of columns in the raw dataset. I suspect it was because there were other unique values in the other columns that produced sparseness if you spread before.
...
The median "Excellent" response value in the dataset is 22%.
...
|  year| county               |  excellent|
|-----:|:---------------------|----------:|
|  2002| NY - New York County |       27.9|
|  2002| NY - Queens County   |       18.8|
|  2003| NY - New York County |       24.6|
|  2003| NY - Queens County   |       16.4|
|  2004| NY - New York County |       27.2|
|  2004| NY - Queens County   |       16.5|
|  2005| NY - New York County |       25.3|
|  2005| NY - Queens County   |       15.7|
|  2006| NY - New York County |       28.8|
|  2006| NY - Queens County   |       18.9|
|  2007| NY - New York County |       26.9|
|  2007| NY - Queens County   |       13.1|
|  2008| NY - New York County |       30.0|
|  2008| NY - Queens County   |       17.6|
|  2009| NY - New York County |       30.4|
|  2009| NY - Queens County   |       17.5|
|  2010| NY - New York County |       25.8|
|  2010| NY - Queens County   |       21.2|
...
Good thing I go to school in New York County.
