...
Next, we need to import and start cleaning the precipitation data from 2016 and 2017. These data sets originally came in two separate sheets, so they will need to be combined later on. Like the trash data, there are some rows that need to be removed since some data are missing in the 2017 precipitation data.
